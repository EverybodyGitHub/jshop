...
(function (b, d) {
    ...
    function Oa(a, c, f) {
        ...
        var i = a.doc, e = [], g = a.cloneRange().down(), h = -1, j = -1, o = -1, n = -1, m = a.commonAncestor(),
    ...
    function Ua(a) {
        ...
        b.mousedown(function (a) {
            ...
            a.stopPropagation();
            var h = b.get(), j = o(c.css("left")), n = o(c.css("top")), m = c.width(), l = c.height(), s = a.pageX,
                q = a.pageY;
            u && u();
    ...
    if (!b.KindEditor) {
        ...
        var Ha = "4.1.7 (2013-04-21)", I = navigator.userAgent.toLowerCase(),
            ...
            pa = I.indexOf("gecko") > -1 && I.indexOf("khtml") == -1, ja = I.indexOf("applewebkit") > -1,
            Na = I.indexOf("opera") > -1, Tb = I.indexOf("mobile") > -1, Ub = /ipad|iphone|ipod/.test(I),
            aa = document.compatMode != "CSS1Compat",
            O = (I = /(?:msie|firefox|webkit|opera)[\/:\s](\d+)/.exec(I)) ? I[1] : "0", Ga = (new Date).getTime(),
            ca = Math.round, i = {
                DEBUG: !1,
                VERSION: Ha,
                IE: C,
            ...
            Vb = z("img,table,input,textarea,button"), Ja = z("pre,style,script"),
        ...
        A(Z, {
            init: function (a) {
                ...
                var c = this.startContainer, b = this.startOffset, d = this.endContainer, i = this.endOffset, k, e, g,
                    h = 1;
        ...
        A(ua, {
            init: function (a) {
                ...
                var a = r(a, !0), c = this.sel, b = this.range.cloneRange().shrink(), d = b.startContainer,
        ...
        A(da, {
            init: function (a) {
                ...
                if (this._alignEl) {
                    var k = i(this._alignEl), g = k.pos(), b = ca(k[0].clientWidth / 2 - b / 2),
            ...
            init: function (a) {
                ...
                if (a.title === "-") this.div.append(i('<div class="ke-menu-separator"></div>'));
                    ...
                    var c = i('<div class="ke-menu-item" unselectable="on"></div>'),
                        ...
                        d = i('<div class="ke-inline-block ke-menu-item-right"></div>'), e = j(a.height),
                        k = r(a.iconClass, "");
                    this.div.append(c);
        ...
        A(Za, {
            init: function (a) {
                var c = i(a.button), b = a.fieldName || "file", d = a.url || "", e = c.val(), k = a.extraParams || {},
                    g = c[0].className || "", h = a.target || "kindeditor_upload_iframe_" + (new Date).getTime();
                ...
                c.bind("load", function () {
                    ...
                    b.reset();
                    i(b).remove(!0);
                    var b = i.iframeDoc(c), d = b.getElementsByTagName("pre")[0], e = "", k,
        ...
        A(za, da, {
            init: function (a) {
                ...
                (e || k || g) && m.append(l);
                h([{btn: e, name: "preview"}, {btn: k, name: "yes"}, {btn: g, name: "no"}], function () {
                    if (this.btn) {
                ...
                this.mask = null;
                if (n) d = X(this.doc), this.mask = Wa({
                    x: 0,
                    y: 0,
                    z: this.z - 1,
                    cls: "ke-dialog-mask",
        ...
        Aa.prototype = {
            lang: function (a) {
                ...
                d ? (c._fullscreenResizeHandler = function () {
                    ...
                    moveEl: k, clickEl: m, moveFn: function (a, b, d, f, e, i) {
                        f += i;
                        c.resize(null, f)
                    }
        ...
        yb("core", function (a) {
            ...
            c.clickToolbar("formatblock", function () {
                var a = c.lang("formatblock.formatBlock"), b = {h1: 28, h2: 24, h3: 18, H4: 14, p: 12},
                    ...
                    f = c.createMenu({name: "formatblock", width: c.langType == "en" ? 200 : 150});
                h(a, function (a, e) {
                    var i = "font-size:" +
                        b[a] + "px;";
            ...
            h("forecolor,hilitecolor".split(","), function (a, b) {
                c.clickToolbar(b, function () {
                    c.createMenu({
                        name: b, selectedColor: c.cmd.val(b) ||
            ...
            h("link,image,flash,media,anchor".split(","), function (a, b) {
                ...
                h("edit,delete".split(","), function (a, e) {
                    c.addContextmenu({
                        title: c.lang(e + f), click: function () {
...
KindEditor.plugin("baidumap", function (b) {
    ...
    d.clickToolbar("baidumap", function () {
        ...
        var m = ['<div style="padding:10px 20px;"><div class="ke-header"><div class="ke-left">', g.address + ' <input id="kindeditor_plugin_map_address" name="address" class="ke-input-text" value="" style="width:200px;" /> ', '<span class="ke-button-common ke-button-outer">', '<input type="button" name="searchBtn" class="ke-button-common ke-button" value="' +
            ...
            m = d.createDialog({
                name: "baidumap", width: l + 42, title: d.lang("baidumap"), body: m, yesBtn: {
                    name: d.lang("yes"), click: function () {
            ...
            }), n = m.div, j = b('[name="address"]', n), o = b('[name="searchBtn"]', n),
...
KindEditor.plugin("clearhtml", function (b) {
    ...
    d.clickToolbar("clearhtml", function () {
        d.focus();
        var g = d.html(), g = g.replace(/(<script[^>]*>)([\s\S]*?)(<\/script>)/ig, ""),
            g = g.replace(/(<style[^>]*>)([\s\S]*?)(<\/style>)/ig, ""), g = b.formatHtml(g, {
                a: ["href", "target"],
    ...
    d.clickToolbar("code", function () {
        var g = d.lang("code."), l = d.createDialog({
            ...
            yesBtn: {
                name: d.lang("yes"),
                click: function () {
                    var h = b(".ke-code-type", l.div).val(), m = e.val(),
...
KindEditor.plugin("emoticons", function (b) {
    var d = this, g = d.emoticonsPath || d.pluginsPath + "emoticons/images/",
        l = d.allowPreviewEmoticons === void 0 ? !0 : d.allowPreviewEmoticons, e = 1;
    d.clickToolbar("emoticons", function () {
        ...
        var s = 5, t = 9, p = 0, q = s * t, z = Math.ceil(135 / q), D = Math.floor(t / 2),
...
KindEditor.plugin("filemanager", function (b) {
    ...
    var g = this, l = b.undef(g.fileManagerJson, g.basePath + "jsp/file_manager_json.jsp"),
    ...
    g.plugin.filemanagerDialog = function (m) {
        ...
        function t(g) {
            ...
            for (var n = g.file_list, m = 0, l = n.length; m < l; m++) {
                ...
                var r = g.current_url + s.filename,
                    r = b('<img src="' + (s.is_dir ? e + "folder-64.gif" : s.is_photo ? r : e + "file-64.gif") + '" width="80" height="80" alt="' + s.filename + '" />');
        ...
        var p = b.undef(m.width, 650), q = b.undef(m.height, 510), z = b.undef(m.dirName, ""),
            ...
            A = g.createDialog({
                name: "filemanager", width: p, height: q, title: g.lang("filemanager"),
                body: m
            }), p = A.div, w = b(".ke-plugin-filemanager-body", p);
        b('[name="moveupImg"]', p);
...
KindEditor.plugin("flash", function (b) {
    var d = this, g = d.lang("flash."), l = b.undef(d.allowFlashUpload, !0), e = b.undef(d.allowFileManager, !1),
        h = b.undef(d.formatUploadUrl, !0), m = b.undef(d.extraFileUploadParams, {}),
        n = b.undef(d.filePostName, "imgFile"), j = b.undef(d.uploadJson, d.basePath + "jsp/upload_json.jsp");
    d.plugin.flash = {
        edit: function () {
            var o = ['<div style="padding:20px;"><div class="ke-dialog-row">', '<label for="keUrl" style="width:60px;">' + g.url + "</label>", '<input class="ke-input-text" type="text" id="keUrl" name="url" value="" style="width:160px;" /> &nbsp;',
                ...
                s = d.createDialog({
                    name: "flash", width: 450, title: d.lang("flash"), body: o, yesBtn: {
                        name: d.lang("yes"), click: function () {
                            ...
                            e == "http://" || b.invalidUrl(e) ? (alert(d.lang("invalidUrl")), p[0].focus()) : /^\d*$/.test(g) ? /^\d*$/.test(h) ? (e = b.mediaImg(d.themesPath + "common/blank.gif", {
                                src: e, type: b.mediaType(".swf"), width: g,
                ...
                }), t = s.div, p = b('[name="url"]', t), o = b('[name="viewServer"]', t), q = b('[name="width"]', t),
                z = b('[name="height"]', t);
            p.val("http://");
            if (l) {
...
KindEditor.plugin("image", function (b) {
    var d = this, g = b.undef(d.allowImageUpload, !0), l = b.undef(d.allowImageRemote, !0),
        e = b.undef(d.formatUploadUrl, !0), h = b.undef(d.allowFileManager, !1),
        m = b.undef(d.uploadJson, d.basePath + "jsp/upload_json.jsp"), n = b.undef(d.imageTabIndex, 0),
        j = d.pluginsPath + "image/images/", o = b.undef(d.extraFileUploadParams, {}),
    ...
    d.plugin.imageDialog = function (g) {
        ...
        var l = b.undef(g.showRemote, !0), r = b.undef(g.showLocal, !0), A = b.undef(g.tabIndex, 0), w = g.clickFn,
        ...
        var v = ['<div style="padding:20px;"><div class="tabs"></div><div class="tab1" style="display:none;"><div class="ke-dialog-row">', '<label for="remoteUrl" style="width:60px;">' +
            ...
            U = d.createDialog({
                name: "image", width: r ||
                h ? 450 : 400, height: r && l ? 300 : 250, title: d.lang("image"), body: v, yesBtn: {
                    name: d.lang("yes"), click: function () {
            ...
            }), F = U.div, N = b('[name="url"]', F), ea = b('[name="localUrl"]', F), V = b('[name="viewServer"]', F),
            Q = b('.tab1 [name="width"]', F), G = b('.tab1 [name="height"]', F), S = b(".ke-refresh-btn", F),
            Y = b('.tab1 [name="title"]', F), M = b('.tab1 [name="align"]', F), J;
        l && r ? (J = b.tabs({
...
KindEditor.plugin("insertfile", function (b) {
    var d = this, g = b.undef(d.allowFileUpload, !0), l = b.undef(d.allowFileManager, !1),
        e = b.undef(d.formatUploadUrl, !0), h = b.undef(d.uploadJson, d.basePath + "jsp/upload_json.jsp"),
        m = b.undef(d.extraFileUploadParams, {}), n = b.undef(d.filePostName, "imgFile"), j = d.lang("insertfile.");
    d.plugin.fileDialog = function (o) {
        var s = b.undef(o.fileUrl, "http://"), t = b.undef(o.fileTitle, ""), p = o.clickFn,
    ...
    d.clickToolbar("map", function () {
        ...
        var e = ['<div style="padding:10px 20px;"><div class="ke-dialog-row">', g.address + ' <input id="kindeditor_plugin_map_address" name="address" class="ke-input-text" value="" style="width:200px;" /> ', '<span class="ke-button-common ke-button-outer">', '<input type="button" name="searchBtn" class="ke-button-common ke-button" value="' + g.search + '" />', '</span></div><div class="ke-map" style="width:558px;height:360px;"></div></div>'].join(""),
            e = d.createDialog({
                ...
                yesBtn: {
                    name: d.lang("yes"), click: function () {
                        var b = n.map, e = b.getCenter().lat() + "," + b.getCenter().lng(), g = b.getZoom(),
...
KindEditor.plugin("media", function (b) {
    var d = this, g = d.lang("media."), l = b.undef(d.allowMediaUpload, !0), e = b.undef(d.allowFileManager, !1),
        h = b.undef(d.formatUploadUrl, !0), m = b.undef(d.extraFileUploadParams, {}),
        n = b.undef(d.filePostName, "imgFile"), j = b.undef(d.uploadJson, d.basePath + "jsp/upload_json.jsp");
    d.plugin.media = {
        edit: function () {
            var o = ['<div style="padding:20px;"><div class="ke-dialog-row">', '<label for="keUrl" style="width:60px;">' + g.url + "</label>", '<input class="ke-input-text" type="text" id="keUrl" name="url" value="" style="width:160px;" /> &nbsp;',
                ...
                s = d.createDialog({
                    name: "media", width: 450, height: 230, title: d.lang("media"), body: o, yesBtn: {
                        name: d.lang("yes"), click: function () {
                            var e = b.trim(p.val()), g = q.val(), h = z.val();
...
KindEditor.plugin("multiimage", function (b) {
    ...
    var g = b.undef(d.uploadJson, d.basePath + "jsp/upload_json.jsp"), l = d.pluginsPath + "multiimage/images/",
    ...
    d.plugin.multiImageDialog = function (j) {
        var o = j.clickFn, j = b.tmpl(n.uploadDesc, {uploadLimit: h, sizeLimit: e}), s = d.createDialog({
            name: "multiimage",
            width: 650,
            height: 510,
...
KindEditor.plugin("plainpaste", function (b) {
    ...
    d.clickToolbar("plainpaste", function () {
        var g = '<div style="padding:10px 20px;"><div style="margin-bottom:10px;">' + d.lang("plainpaste.").comment + '</div><textarea class="ke-textarea" style="width:408px;height:260px;"></textarea></div>',
            g = d.createDialog({
                name: "plainpaste", width: 450, title: d.lang("plainpaste"), body: g, yesBtn: {
                    name: d.lang("yes"), click: function () {
                        var e = l.val(), e = b.escape(e), e = e.replace(/ {2}/g, " &nbsp;"),
    ...
    function g(g, h) {
        ...
        h.click(function () {
            ...
            var h = b(this), j = h.pos(), j = b.colorpicker({
                x: j.x, y: j.y + h.height(), z: 811214, selectedColor: b(this).html(), colors: e.colorTable,
    ...
    e.plugin.table = {
        prop: function (n) {
            var j = ['<div style="padding:20px;"><div class="ke-dialog-row">', '<label for="keRows" style="width:90px;">' + h.cells + "</label>", h.rows + ' <input type="text" id="keRows" class="ke-input-text ke-input-number" name="rows" value="" maxlength="4" /> &nbsp; ',
                ...
                j = e.createDialog({
                    name: "table", width: 500, title: e.lang("table"), body: j, beforeRemove: function () {
                        H.unbind()
                    }, yesBtn: {
                        name: e.lang("yes"), click: function () {
                            var d = o.val(), g = l.val(), h = m.val(), j = p.val(), n = q.val(), E = z.val(),
                                G = D.val(), S = r.val(), Y = A.val(),
                ...
                }).div, o = b('[name="rows"]', j).val(3), l = b('[name="cols"]', j).val(2),
                m = b('[name="width"]', j).val(100), p = b('[name="height"]', j), q = b('[name="widthType"]', j),
                z = b('[name="heightType"]', j), D = b('[name="padding"]', j).val(2),
                r = b('[name="spacing"]', j).val(0), A = b('[name="align"]', j), w = b('[name="border"]', j).val(1),
            ...
            var n = ['<div style="padding:20px;"><div class="ke-dialog-row">', '<label for="keWidth" style="width:90px;">' + h.size + "</label>", h.width + ' <input type="text" id="keWidth" class="ke-input-text ke-input-number" name="width" value="" maxlength="4" /> &nbsp; ',
                ...
                n = e.createDialog({
                    name: "table", width: 500, title: e.lang("tablecell"), body: n, beforeRemove: function () {
                        ...
                        name: e.lang("yes"), click: function () {
                            ...
                            p.val();
                            q.val();
                            var H = z.val(), ea = D.val(), V = r.val(), Q = b(A[0]).html() || "",
                                G = b(A[1]).html() || "";
                ...
                }).div, j = b('[name="width"]', n).val(100), o = b('[name="height"]', n),
                l = b('[name="widthType"]', n), m = b('[name="heightType"]', n), p = b('[name="padding"]', n).val(2),
                q = b('[name="spacing"]', n).val(0), z = b('[name="textAlign"]', n), D = b('[name="verticalAlign"]', n),
            ...
            var g = e.plugin.getSelectedTable()[0], h = e.plugin.getSelectedRow()[0], m = e.plugin.getSelectedCell()[0],
                d = m.cellIndex + d;
            ...
            var g = e.plugin.getSelectedTable()[0], h = e.plugin.getSelectedRow()[0], l = e.plugin.getSelectedCell()[0],
                m = h.rowIndex;
            ...
            var b = e.plugin.getSelectedTable()[0], d = e.plugin.getSelectedRow()[0], g = e.plugin.getSelectedCell()[0],
                h = d.rowIndex + g.rowSpan, d = b.rows[h];
...
KindEditor.plugin("template", function (b) {
    ...
    g.clickToolbar("template", function () {
        ...
        var e = g.createDialog({
                ...
                body: html,
                yesBtn: {
                    name: g.lang("yes"), click: function () {
                        var d = b.iframeDoc(j);
...
KindEditor.plugin("wordpaste", function (b) {
    ...
    d.clickToolbar("wordpaste", function () {
        var g = '<div style="padding:10px 20px;"><div style="margin-bottom:10px;">' + d.lang("wordpaste.").comment + '</div><iframe class="ke-textarea" frameborder="0" style="width:408px;height:260px;"></iframe></div>',
            g = d.createDialog({
                name: "wordpaste", width: 450, title: d.lang("wordpaste"), body: g, yesBtn: {
                    name: d.lang("yes"), click: function () {
