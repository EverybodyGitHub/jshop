...
<!-- 			<a href="selectList?init=y" class="btn btn-inverse">返回</a> -->
			...
			<div id="tabs-1">
				...
				<div class="row form-horizontal"-role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
							<input type="button" name="fileBtn" id ="coverImgFileBtn" value="点击上传图片" class="btn btn-success"/>
							<input type="file" name="uploadFile" id ="coverImgUploadFile" accept="image/png, image/jpeg, image/gif, image/jpg" style="display: none"/>
							<#if e.picture??>
		...
		<!-- 					<th>设为封面</th> -->
				...
				<table class="table table-bordered">
					...
					<tr>
						<td>
							<input type="button" name="fileBtn" id ="detailImgsFileBtn" value="点击上传图片" class="btn btn-success"/>
							<input type="file" name="uploadFile" id ="detailImgsUploadFile" accept="image/png, image/jpeg, image/gif, image/jpg" multiple="multiple" style="display: none"/>
					</tr>
...
<script>
	$(document).ready(function(){
		$('#coverImgFileBtn').click(function(){
			$('#coverImgUploadFile').click();
		});

		$('#detailImgsFileBtn').click(function(){
			$('#detailImgsUploadFile').click();
		});
